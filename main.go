...
//
// STATUS: SCAFFOLD / DESIGN — NOT verified against a cluster. The token
// verification (token.go) is fully and correctly implemented and unit-tested.
// The Kubernetes pod-discovery and log-multiplex bodies are TODO-stubbed; see
// docs/SIDECAR.md in the odoo_herd_portal module for the full design.
package main
...
func (s *server) handleStream(w http.ResponseWriter, r *http.Request) {
	...
	// streamLogs ONLY uses scope.Ns and scope.Sel for scoping.
	if err := streamLogs(ctx, scope, w, flusher); err != nil && ctx.Err() == nil {
